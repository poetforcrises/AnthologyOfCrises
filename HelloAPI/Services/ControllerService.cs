...
namespace Shortener.Service.Services
{
    public class ControllerService : IControllerService
    {
       ...
       // private string targetUrl = "infobip.com";
        // 
        public ControllerService(IUrlHelper urlHelper, IDbContext dbContext, IMapper mapper, ILogger<ControllerService> logger)
        {
        ...
        public UrlDataDto AddUrlData(UrlDataDto urlDataDto, string requestScheme, string requestHost)
        {
            ...
            UrlDataDto responseUrlDataDto = new UrlDataDto() { Url = $"https://{requestHost}/{_urlHelper.GetShortUrl(id)}" };
